...
import { Params } from "../comments/params";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("chat.comments.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
  }

  Comment(request: QueryGetCommentRequest): Promise<QueryGetCommentResponse> {
    const data = QueryGetCommentRequest.encode(request).finish();
    const promise = this.rpc.request("chat.comments.Query", "Comment", data);
  ...
  CommentAll(
    ...
    const promise = this.rpc.request("chat.comments.Query", "CommentAll", data);
    return promise.then((data) =>
