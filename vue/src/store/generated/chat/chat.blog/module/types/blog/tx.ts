...
export const protobufPackage = "chat.blog";
...
export class MsgClientImpl implements Msg {
  ...
  CreatePost(request: MsgCreatePost): Promise<MsgCreatePostResponse> {
    ...
    const promise = this.rpc.request("chat.blog.Msg", "CreatePost", data);
  ...
  UpdatePost(request: MsgUpdatePost): Promise<MsgUpdatePostResponse> {
    ...
    const promise = this.rpc.request("chat.blog.Msg", "UpdatePost", data);
    return promise.then((data) =>
  ...
  DeletePost(request: MsgDeletePost): Promise<MsgDeletePostResponse> {
    ...
    const promise = this.rpc.request("chat.blog.Msg", "DeletePost", data);
    return promise.then((data) =>
