...
func (m *MsgCreatePost) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "chat.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "chat.blog.MsgCreatePostResponse")
	proto.RegisterType((*MsgUpdatePost)(nil), "chat.blog.MsgUpdatePost")
	proto.RegisterType((*MsgUpdatePostResponse)(nil), "chat.blog.MsgUpdatePostResponse")
	proto.RegisterType((*MsgDeletePost)(nil), "chat.blog.MsgDeletePost")
	proto.RegisterType((*MsgDeletePostResponse)(nil), "chat.blog.MsgDeletePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x4c, 0xce, 0x48, 0x2c, 0xd1,
	0x03, 0x89, 0x49, 0xf1, 0x83, 0x65, 0x0a, 0xf2, 0x8b, 0x4b, 0x20, 0x72, 0x4a, 0xe9, 0x5c, 0xbc,
	...
	,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdatePost(ctx context.Context, in *MsgUpdatePost, opts ...grpc.CallOption) (*MsgUpdatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.blog.Msg/UpdatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) DeletePost(ctx context.Context, in *MsgDeletePost, opts ...grpc.CallOption) (*MsgDeletePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.blog.Msg/DeletePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.blog.Msg/CreatePost",
	}
...
func _Msg_UpdatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.blog.Msg/UpdatePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_DeletePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.blog.Msg/DeletePost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
